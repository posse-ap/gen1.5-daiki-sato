...
export const StudyingHourApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        monthStudyingHourYearIdMonthIdGet: async (monthId: number, yearId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const StudyingHourApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async monthStudyingHourYearIdMonthIdGet(monthId: number, yearId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MonthStudyingHour>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.monthStudyingHourYearIdMonthIdGet(monthId, yearId, options);
         ...
         * @throws {RequiredError}
         */
        async todaySftudyingHoursGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TodayStudyingHour>> {
         ...
         * @throws {RequiredError}
         */
        async totalStudyingHoursGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TotalStudyingHour>> {
 ...
 * @export
 */
export const StudyingHourApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        monthStudyingHourYearIdMonthIdGet(monthId: number, yearId: number, options?: any): AxiosPromise<MonthStudyingHour> {
            return localVarFp.monthStudyingHourYearIdMonthIdGet(monthId, yearId, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns today studying hour.
         * @summary Get today studying hour.
...
export class StudyingHourApi extends BaseAPI {
     ...
     */
    public monthStudyingHourYearIdMonthIdGet(monthId: number, yearId: number, options?: AxiosRequestConfig) {
        return StudyingHourApiFp(this.configuration).monthStudyingHourYearIdMonthIdGet(monthId, yearId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public todaySftudyingHoursGet(options?: AxiosRequestConfig) {
        return StudyingHourApiFp(this.configuration).todaySftudyingHoursGet(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public totalStudyingHoursGet(options?: AxiosRequestConfig) {
        return StudyingHourApiFp(this.configuration).totalStudyingHoursGet(options).then((request) => request(this.axios, this.basePath));
    }
}
