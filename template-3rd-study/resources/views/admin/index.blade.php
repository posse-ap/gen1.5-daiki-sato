            ...
            <div class="col-md-8">
                <div class="">
                    @foreach ($big_question_data as $big_question)
                        <h2>{{ $big_question->name }}の問題</h2>
                        <a class="btn btn-outline-primary mb-1" href="{{ route('admin.big_question_edit', ['id' => $big_question->id]) }}">編集</a>
                        <form method="post" action="{{ route('admin.big_question_delete', $big_question->id) }}">
                            {{ csrf_field() }}
                        ...
                        @foreach ($big_question->questions as $question)
                            <div class="border border-secondary p-3 my-2 d-flex">
                                <div class=" d-flex flex-column mr-auto">
                                    ...
                                    <form action="{{ route('admin.choice_add') }}" method="POST">
                                        @csrf
                                        <div class="mb-3 border border-secondar p-3 mt-2">
                                            ...
                                            <div class="d-flex ">
                                                ...
                                                <input name="valid" placeholder="正解なら1,不正解なら0" type="number" class="form-control mr-3">
